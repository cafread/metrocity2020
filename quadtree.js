...
class QuadTree {
  ...
  static create () {
    ...
    if (arguments.length === 0) {
      if (typeof width  === "undefined") throw new TypeError("No global width defined");
      if (typeof height === "undefined") throw new TypeError("No global height defined");
  ...
  toJSON (isChild) {
    ...
    if (this.divided) {
      if (this.northeast.points.length > 0) obj.ne = this.northeast.toJSON(true);
      if (this.northwest.points.length > 0) obj.nw = this.northwest.toJSON(true);
      if (this.southeast.points.length > 0) obj.se = this.southeast.toJSON(true);
      if (this.southwest.points.length > 0) obj.sw = this.southwest.toJSON(true);
    }
    if (!isChild) {
  ...
  closest (point, count, maxDistance) {
    if (typeof point === "undefined") throw TypeError("Method 'closest' needs a point");
    if (typeof count === "undefined") count = 1;
    // Limit to number of points in this QuadTree
    if (this.length == 0) return [];
    if (this.length < count) return this.points;
